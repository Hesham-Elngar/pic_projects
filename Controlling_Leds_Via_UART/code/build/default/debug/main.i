...
# 5 "D:\\CodingPrograms\\xc8\\pic\\include\\c99\\stdint.h" 2 3
...
# 1 "./application.h" 1
# 12 "./application.h"
# 1 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h" 1
# 12 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h"
...
# 10 "D:\\CodingPrograms\\xc8\\pic\\include\\c99\\stdlib.h" 3
...
# 12 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h" 2
...
# 13 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h" 2
...
# 14 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h" 2
...
# 15 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h" 2
...
# 16 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h" 2
...
# 17 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h" 2
...
# 18 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h" 2
...
# 19 "./ECU_Layer/ecu_layer_init/ecu_layer_init.h" 2
...
# 11 "./MCAL_Layer/Timers/../interrupt/interrupt_config.h"
# 1 "./MCAL_Layer/Timers/../interrupt/interrupt_gen_cfg.h" 1
# 11 "./MCAL_Layer/Timers/../interrupt/interrupt_config.h" 2
# 36 "./MCAL_Layer/Timers/../interrupt/interrupt_config.h"
typedef enum{
     Interrupt_Low_Priority=0,
     Interrupt_High_Priority,
}Interrupt_Priority_Levels;
# 11 "./MCAL_Layer/Timers/../interrupt/internal_interrupt.h" 2
# 12 "./MCAL_Layer/Timers/timer0.h" 2
# 41 "./MCAL_Layer/Timers/timer0.h"
typedef enum{
...
# 49 "./MCAL_Layer/interrupt/external_interrupt.h"
typedef enum{
    EXT_INT0,
    EXT_INT1,
    EXT_INT2
...
# 1 "./MCAL_Layer/USART/usart.h" 1
# 53 "./MCAL_Layer/USART/usart.h"
typedef enum{
...
void uart_init()
{
    ...
    obj.usart_rx_cfg.usart_rx_enable=1;
    obj.usart_rx_cfg.usart_rx_9bit_enable=0;
    obj.usart_rx_cfg.usart_rx_interrupt_enable=0;

    obj.usart_tx_cfg.usart_tx_9bit_enable=0;
    obj.usart_tx_cfg.usart_tx_enable=1;
    obj.usart_tx_cfg.usart_tx_interrupt_enable=0;

    obj.EUSART_FramingErrorHandler=((void*)0);
    obj.EUSART_OverrunErrorHandler=((void*)0);
    obj.EUSART_RxDefaultInterruptHandler=((void*)0);
    obj.EUSART_TxDefaultInterruptHandler=((void*)0);
    Uart_Init(&obj);
}
u8 data ;
