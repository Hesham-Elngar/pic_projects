...
# 10 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/GPIO.h"
# 1 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../STD_Types.h" 1
# 10 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../STD_Types.h"
...
# 10 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/../STD_Types.h" 2
...
# 10 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/GPIO.h" 2
...
# 24 "ECU_Layer/DC_Motor/dc_motor.h"
typedef struct{
...
Return_Status dc_motor_move_right(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        gpio_write_pin_logic(&(_dc_motor->dc_motor_pin[0]), gpio_logic_high);
        gpio_write_pin_logic(&(_dc_motor->dc_motor_pin[1]), gpio_logic_low);
    }
    return ret;
}
...
Return_Status dc_motor_move_left(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        gpio_write_pin_logic(&(_dc_motor->dc_motor_pin[0]), gpio_logic_low);
        gpio_write_pin_logic(&(_dc_motor->dc_motor_pin[1]), gpio_logic_high);
    }
    return ret;
}
# 46 "ECU_Layer/DC_Motor/dc_motor.c"
Return_Status dc_motor_stop(const dc_motor_t *_dc_motor){
    Return_Status ret = R_OK;
    if(((void*)0) == _dc_motor){
        ret = R_NOK;
