...
# 5 "MCAL_Layer/CCP/hal_ccp.h" 2

# 1 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/GPIO.h" 1
# 10 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/GPIO.h"
# 1 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../STD_Types.h" 1
# 10 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../STD_Types.h"
# 1 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../Compiler.h" 1
# 12 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../Compiler.h"
...
# 12 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../Compiler.h" 2
# 10 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../STD_Types.h" 2

# 1 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../std_libraries.h" 1
# 12 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 12 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../std_libraries.h" 2
# 11 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../STD_Types.h" 2
...
# 10 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/GPIO.h" 2

# 1 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/../BIT_math.h" 1
# 11 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/GPIO.h" 2


# 1 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/hal_gpio_config.h" 1
# 13 "MCAL_Layer/CCP/../../MCAL_Layer/GPIO/GPIO.h" 2
...
# 6 "MCAL_Layer/CCP/hal_ccp.h" 2

# 1 "MCAL_Layer/CCP/../../MCAL_Layer/interrupt/internal_interrupt.h" 1
# 11 "MCAL_Layer/CCP/../../MCAL_Layer/interrupt/internal_interrupt.h"
# 1 "MCAL_Layer/CCP/../../MCAL_Layer/interrupt/interrupt_config.h" 1
# 11 "MCAL_Layer/CCP/../../MCAL_Layer/interrupt/interrupt_config.h"
# 1 "MCAL_Layer/CCP/../../MCAL_Layer/interrupt/interrupt_gen_cfg.h" 1
# 11 "MCAL_Layer/CCP/../../MCAL_Layer/interrupt/interrupt_config.h" 2
# 36 "MCAL_Layer/CCP/../../MCAL_Layer/interrupt/interrupt_config.h"
typedef enum{
     Interrupt_Low_Priority=0,
     Interrupt_High_Priority,
}Interrupt_Priority_Levels;
# 11 "MCAL_Layer/CCP/../../MCAL_Layer/interrupt/internal_interrupt.h" 2
# 7 "MCAL_Layer/CCP/hal_ccp.h" 2

# 1 "MCAL_Layer/CCP/ccp_cfg.h" 1
# 8 "MCAL_Layer/CCP/hal_ccp.h" 2
# 66 "MCAL_Layer/CCP/hal_ccp.h"
typedef enum{
...
typedef struct{
    ...
    Interrupt_Priority_Levels CCP1_priority;
...
Return_Status CCP_Init(const ccp_t *_ccp_obj){
    ...
    if(((void*)0) == _ccp_obj){
        ...
        if(CCP1_INST == _ccp_obj->ccp_inst){
            (CCP1CONbits.CCP1M = ((u8)0x00));
        }
        else if(CCP2_INST == _ccp_obj->ccp_inst){
            (CCP2CONbits.CCP2M = ((u8)0x00));
        }
        else { }
        ...
        if(CCP_CAPTURE_MODE_SELECTED == _ccp_obj->ccp_mode){
            ...
            PR2 = (u8)((8000000UL / (_ccp_obj->PWM_Frequency * 4.0 * _ccp_obj->timer2_prescaler_value * _ccp_obj->timer2_postscaler_value)) - 1);
        }
...
Return_Status CCP_PWM_Start(const ccp_t *_ccp_obj){
    ...
    if(((void*)0) == _ccp_obj){
        ...
        if(CCP1_INST == _ccp_obj->ccp_inst){
            CCP1CONbits.CCP1M = ((u8)0x0C);
        }
        else if(CCP2_INST == _ccp_obj->ccp_inst){
            CCP2CONbits.CCP2M = ((u8)0x0C);
        }
        else{ }
        ret = R_OK;
    }
    ...
    if(((void*)0) == _ccp_obj){
        ...
        if(CCP1_INST == _ccp_obj->ccp_inst){
            switch(_ccp_obj->ccp_mode_variant){
                case ((u8)0x09):
                    (CCP1CONbits.CCP1M = ((u8)0x09));
                    break;
                case ((u8)0x08):
                    (CCP1CONbits.CCP1M = ((u8)0x08));
                    break;
                case ((u8)0x02):
                    (CCP1CONbits.CCP1M = ((u8)0x02));
                    break;
                case ((u8)0x0A):
                    (CCP1CONbits.CCP1M = ((u8)0x0A));
                    break;
                case ((u8)0x0B):
                    (CCP1CONbits.CCP1M = ((u8)0x0B));
                    break;
            ...
            switch(_ccp_obj->ccp_mode_variant){
                case ((u8)0x09):
                    (CCP2CONbits.CCP2M = ((u8)0x09));
                    break;
                case ((u8)0x08):
                    (CCP2CONbits.CCP2M = ((u8)0x08));
                    break;
                case ((u8)0x02):
                    (CCP2CONbits.CCP2M = ((u8)0x02));
                    break;
                case ((u8)0x0A):
                    (CCP2CONbits.CCP2M = ((u8)0x0A));
                    break;
                case ((u8)0x0B):
                    (CCP2CONbits.CCP2M = ((u8)0x0B));
                    break;
                default: ret = R_NOK; break;
            }
            ret = R_OK;
