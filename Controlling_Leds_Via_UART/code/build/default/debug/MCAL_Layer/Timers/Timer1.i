...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Timers/Timer1.c" 2
# 1 "MCAL_Layer/Timers/Timer1.h" 1
# 11 "MCAL_Layer/Timers/Timer1.h"
...
# 11 "MCAL_Layer/Timers/Timer1.h" 2
# 44 "MCAL_Layer/Timers/Timer1.h"
typedef enum{
...
# 2 "MCAL_Layer/Timers/Timer1.c" 2


static __attribute__((inline)) Return_Status timer1_prescaler_cfg(Timer1_t* timer1);
static __attribute__((inline)) Return_Status timer1_mode_cfg(Timer1_t* timer1);
...
static __attribute__((inline)) Return_Status timer1_mode_cfg(Timer1_t* timer1){
    ...
    if(timer1){
        ...
        if(timer1->mode==1){
             T1CONbits.TMR1CS=1;
             if(timer1->counter_mode==0) T1CONbits.T1SYNC=0;
             else if(timer1->counter_mode==1) T1CONbits.T1SYNC=1;
        }
        else if(timer1->mode==0) T1CONbits.TMR1CS=0;
    }
    return ret;
}
