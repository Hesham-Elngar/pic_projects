...
# 11 "MCAL_Layer/Timers/timer0.h"
# 1 "MCAL_Layer/Timers/../GPIO/GPIO.h" 1
# 10 "MCAL_Layer/Timers/../GPIO/GPIO.h"
# 1 "MCAL_Layer/Timers/../GPIO/../STD_Types.h" 1
# 10 "MCAL_Layer/Timers/../GPIO/../STD_Types.h"
...
# 10 "MCAL_Layer/Timers/../GPIO/../STD_Types.h" 2
...
# 11 "MCAL_Layer/Timers/../GPIO/../STD_Types.h" 2
...
# 10 "MCAL_Layer/Timers/../GPIO/GPIO.h" 2

# 1 "MCAL_Layer/Timers/../GPIO/../BIT_math.h" 1
# 11 "MCAL_Layer/Timers/../GPIO/GPIO.h" 2


# 1 "MCAL_Layer/Timers/../GPIO/hal_gpio_config.h" 1
# 13 "MCAL_Layer/Timers/../GPIO/GPIO.h" 2
...
# 11 "MCAL_Layer/Timers/timer0.h" 2
...
static __attribute__((inline)) Return_Status timer0_prescaler_cfg(TIMER0_t* timer0);
static __attribute__((inline)) Return_Status timer0_mode_cfg(TIMER0_t* timer0);
static __attribute__((inline)) Return_Status timer0_Register_size_Config(TIMER0_t* timer0);
...
static __attribute__((inline)) Return_Status timer0_Register_size_Config(TIMER0_t* timer0){
    ...
    if(timer0){
        ret=R_OK;
        if(timer0->register_size==0){
            T0CONbits.T08BIT=0;
        }
        else if(timer0->register_size==1){
            T0CONbits.T08BIT=1;
        }
    }
        return ret;
