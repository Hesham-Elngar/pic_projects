...
# 5 "D:\\CodingPrograms\\xc8\\pic\\include\\c99\\string.h" 2 3
...
# 11 "D:\\CodingPrograms\\xc8\\pic\\include\\c99\\string.h" 2 3
...
# 10 "MCAL_Layer/ADC/../GPIO/GPIO.h"
# 1 "MCAL_Layer/ADC/../GPIO/../STD_Types.h" 1
# 10 "MCAL_Layer/ADC/../GPIO/../STD_Types.h"
...
# 10 "MCAL_Layer/ADC/../GPIO/../STD_Types.h" 2
...
# 11 "MCAL_Layer/ADC/../GPIO/../STD_Types.h" 2
...
# 10 "MCAL_Layer/ADC/../GPIO/GPIO.h" 2

# 1 "MCAL_Layer/ADC/../GPIO/../BIT_math.h" 1
...
# 36 "MCAL_Layer/ADC/../interrupt/interrupt_config.h"
typedef enum{
...
static __attribute__((inline)) Return_Status adc_input_channel_port_cofigure(ADC_InputChannel_t channel);
static __attribute__((inline)) Return_Status adc_select_format(ADC_Config_t* adc);
static __attribute__((inline)) Return_Status adc_select_voltage_reference(ADC_Config_t* adc);
...
Return_Status ADC_IsConverionDone(ADC_Config_t* adc,u8* ConverionStatus){
    Return_Status ret=R_NOK;
    if(adc!=((void*)0)&&ConverionStatus!=((void*)0)){
        ret=R_OK;
 ...
 Return_Status ADC_GetConverionResult(ADC_Config_t* adc,adc_result* result){
    Return_Status ret=R_NOK;
    if(adc!=((void*)0)&&result){
        ret=R_OK;
        if(adc->ADC_Result_Format==1){
            *result=(u16)(ADRESL+(ADRESH<<8));
        }
        else if(adc->ADC_Result_Format==0) {
...
static __attribute__((inline)) Return_Status adc_input_channel_port_cofigure(ADC_InputChannel_t channel){
    Return_Status ret=R_OK;
        switch(channel){
            case ADC_AN0_CHANNEL: TRISA|=(1<<0x0); break;
            case ADC_AN1_CHANNEL: TRISA|=(1<<0x1); break;
            case ADC_AN2_CHANNEL: TRISA|=(1<<0x2); break;
            case ADC_AN3_CHANNEL: TRISA|=(1<<0x3); break;
            case ADC_AN4_CHANNEL: TRISA|=(1<<0x5); break;
            case ADC_AN5_CHANNEL: TRISE|=(1<<0x0); break;
            case ADC_AN6_CHANNEL: TRISE|=(1<<0x1); break;
            case ADC_AN7_CHANNEL: TRISE|=(1<<0x2); break;
            case ADC_AN8_CHANNEL: TRISB|=(1<<0x2); break;
            case ADC_AN9_CHANNEL: TRISB|=(1<<0x3); break;
            case ADC_AN10_CHANNEL: TRISB|=(1<<0x1); break;
            case ADC_AN11_CHANNEL: TRISB|=(1<<0x4); break;
            case ADC_AN12_CHANNEL: TRISB|=(1<<0x0); break;
...
static __attribute__((inline)) Return_Status adc_select_format(ADC_Config_t* adc){
    ...
    if(adc!=((void*)0)){
        ret=R_OK;
        if(adc->ADC_Result_Format==1) ADCON2bits.ADFM=1;
        else if(adc->ADC_Result_Format==0) ADCON2bits.ADFM=0;
...
static Return_Status adc_select_voltage_reference(ADC_Config_t* adc){
    ...
    if(adc!=((void*)0)){
        ret=R_OK;
        if(adc->ADC_Voltage_Reference==1) do{ ADCON1bits.VCFG0=1; ADCON1bits.VCFG1=1; }while(0);
        else if(adc->ADC_Voltage_Reference==0) do{ ADCON1bits.VCFG0=0; ADCON1bits.VCFG1=0; }while(0);
