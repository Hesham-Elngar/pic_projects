...
# 10 "MCAL_Layer/GPIO/GPIO.h"
# 1 "MCAL_Layer/GPIO/../STD_Types.h" 1
# 10 "MCAL_Layer/GPIO/../STD_Types.h"
...
# 10 "MCAL_Layer/GPIO/../STD_Types.h" 2
...
# 1 "MCAL_Layer/GPIO/gpio_private.h" 1
# 3 "MCAL_Layer/GPIO/GPIO.c" 2
...
Return_Status gpio_set_pin_direction( pin_config_info *pin_config){
    ...
    if(pin_config!=((void*)0)&&pin_config->pin<=PIN7_INDEX&&pin_config->port<=PORTE_INDEX){
        ret=R_OK;
...
Return_Status gpio_get_pin_direction(pin_config_info *pin_config,direction_t *direction)
{
    ...
    if(pin_config!=((void*)0)&&pin_config->pin<=PIN7_INDEX&&pin_config->port<=PORTE_INDEX){
        ret=R_OK;
        *direction=((*tris_registers[pin_config->port]>>pin_config->pin)&1);
...
Return_Status gpio_read_pin_logic(pin_config_info* pin_config,logic_t *logic){
    Return_Status ret=R_NOK;
    if(pin_config!=((void*)0)&&((void*)0)!=logic&&pin_config->pin<=PIN7_INDEX&&pin_config->port<=PORTE_INDEX){
        ret=R_OK;
        *logic=(*PORT_registers[pin_config->port]&(1<<pin_config->pin))>>pin_config->pin;
    }
    return ret;
}
...
Return_Status gpio_set_port_direction(port_index_t port,direction_t direction)
{
    ...
    if(port<=PORTE_INDEX){
        ret=R_OK;
        if(direction==gpio_direction_input) direction=0xff;
...
{
    Return_Status ret=R_NOK;
    if(port<=PORTE_INDEX&&direction!=((void*)0))
    {
        ret=R_OK;
...
Return_Status gpio_write_port_logic(port_index_t port,u8 logic){
    ...
    {
        ret=R_OK;
        if(logic==gpio_logic_high) logic=0xff;
