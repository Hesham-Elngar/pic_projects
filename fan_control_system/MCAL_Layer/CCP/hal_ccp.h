...
typedef struct{
    ...
    pin_config_info ccp_pin;      /* CCP Pin I/O configurations */
    ...
    Interrupt_Priority_Levels CCP1_priority;   /* Configure the CCP1 mode interrupt */
#endif
...
Return_Status CCP1_Capture_Mode_Read_Value(uint16 *capture_value);
#endif

#if (CCP1_CFG_SELECTED_MODE==CCP_CFG_COMPARE_MODE_SELECTED)
Return_Status CCP_IsCompareComplete(u8 *_compare_status);
Return_Status CCP_Compare_Mode_Set_Value(const ccp_t *_ccp_obj, uint16 compare_value);
#endif
